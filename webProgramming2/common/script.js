...
const loadingScreenHTML = `
    <div id="loadingScreen">
        <div id='loadingImage'>
            <img src="/portfolio/webProgramming2/images/01logo.svg">
        </div>
    </div>`;
...
/* /// header,footerの読み込み /// */
fetch("/portfolio/webProgramming2/common/header.html")
...
fetch("/portfolio/webProgramming2/common/footer.html")
    .then((response) => response.text())
    .then((data) => {
...
cssLink.href = '/portfolio/webProgramming2/common/style.css';
